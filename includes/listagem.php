...
if (isset($_POST['pontos'], $_POST['id'], $_POST['nome'])) {
  ...
  $obAluno->updatePoints("escola_gloria", $_POST['id']);
...
<div class="col-12">
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-title">Pontuação Gloria Pérez 🥇</h4>
                    ...
                    <div class="modal-body">
                      ...
                      <form method="POST" action="">
                        ...
                        <div class="modal-footer">
                          <button type="submit" class="btn btn-outline-success">Adicionar Pontuação</button>
