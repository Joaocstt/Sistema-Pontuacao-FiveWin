                ...
                <form class="forms-sample">
                    ...
                    <div class="form-group">
                        ...
                        <select name="escola" class="form-control" id="exampleSelectGender" required>
                            ...
                            <option value="Sebastião Pedrosa"<?php if(isset($obAluno->Escola)) echo "SELECTED";  ?> >Sebastião Pedrosa</option>
                        </select>
                    </div>
                    <button type="submit" class="btn btn-primary mr-2">Salvar</button>
                    <a href="consulta2.php" type="submit" class="btn btn-danger">Cancelar</a>
                </form>
            </div>
        </div>
    </div>
